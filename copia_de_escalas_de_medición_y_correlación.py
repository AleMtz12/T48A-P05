...
Original file is located at
    https://colab.research.google.com/drive/1YYrTaT4ojoYByV7BNmQRDvrk--oFoKQf
...
data = {
    ...
    "Precio": [39990, 41990, 43990, 45990, 47990,
...
def operations(model):
    df_model = df[df["Modelo"].astype(str) == str(model)]
    x = df_model["Año"]
    y = df_model["Precio"]
...
print("Model 3:", regresion_lineal_model_3())
